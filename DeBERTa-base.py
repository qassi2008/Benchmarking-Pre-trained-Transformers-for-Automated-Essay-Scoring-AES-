...
from transformers import DebertaTokenizer, AutoModel, AutoTokenizer
from torch.optim import AdamW
from torch.utils.data import DataLoader, Dataset
from transformers import DebertaTokenizer, DebertaModel, get_cosine_schedule_with_warmup
...
# ====================================================
class CFG:
    model = "microsoft/deberta-base"  # Using DeBERTa-base
    batch_size = 8
    epochs = 100
    encoder_lr = 2e-5
    decoder_lr = 2e-5
...
def train_model(train_df, val_df, tokenizer, config):
    ...
    for epoch in range(config.epochs):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), OUTPUT_DIR / "best_model_Deberta_base.pth")
...
# ====================================================
tokenizer = DebertaTokenizer.from_pretrained(CFG.model)
...
# ====================================================
# Final Evaluation and Display Sample Predictions
# ====================================================
print("\n=== Training Complete DeBERTa-base  ===")
